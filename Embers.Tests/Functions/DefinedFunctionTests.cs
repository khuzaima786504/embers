...
namespace Embers.Tests.Functions
{
    ...
    public class DefinedFunctionTests
    {
        ...
        public void DefineAndExecuteSimplePuts()
        {
            ...
            DefinedFunction function = new(new CallExpression("puts", [new ConstantExpression(123)]), [], machine.RootContext);
        ...
        public void DefineAndExecuteFunctionWithParameters()
        {
            ...
            DefinedFunction function = new(new AddExpression(new NameExpression("a"), new NameExpression("b")), ["a", "b"], context);
