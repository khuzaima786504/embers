...
namespace Embers.Tests.Expressions
{
    ...
    public class ForInExpressionTests
    {
        ...
        public void ExecuteForIn()
        {
            ...
            ForInExpression command = new("k", new ConstantExpression(new int[] { 1, 2, 3 }), new AssignExpression("total", new AddExpression(new NameExpression("total"), new NameExpression("k"))));
        ...
        public void Equals()
        {
            ForInExpression cmd1 = new("k", new ConstantExpression(1), new ConstantExpression(2));
            ForInExpression cmd2 = new("j", new ConstantExpression(1), new ConstantExpression(2));
            ForInExpression cmd3 = new("k", new ConstantExpression(2), new ConstantExpression(2));
            ForInExpression cmd4 = new("k", new ConstantExpression(1), new ConstantExpression(3));
            ForInExpression cmd5 = new("k", new ConstantExpression(1), new ConstantExpression(2));
