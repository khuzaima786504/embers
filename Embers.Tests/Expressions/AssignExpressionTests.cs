...
namespace Embers.Tests.Expressions
{
    ...
    public class AssignExpressionTests
    {
        ...
        {
            AssignExpression expr = new("one", new ConstantExpression(1));
            Context context = new();
        ...
        public void Equals()
        {
            AssignExpression expr1 = new("a", new ConstantExpression(1));
            AssignExpression expr2 = new("a", new ConstantExpression(2));
            AssignExpression expr3 = new("b", new ConstantExpression(1));
            AssignExpression expr4 = new("a", new ConstantExpression(1));
